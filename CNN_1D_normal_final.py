...
from keras.layers import Dense, Activation, Flatten, Dropout, MaxPooling1D, Conv1D
...
#                testFeature = MinMaxScaler().fit_transform(testFeature)
                ...
                save_folder_final = baseFolder + '/python/' + label_type + '_normal_final/result_all_percent_' + str(select_percent) + '_winsize_' + str(int(select_win_size*fs)) + '_winover_' + str(select_win_over)
